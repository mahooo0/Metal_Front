...
export function MetalBrandSelect({
  ...
  const selectedBrand = metalBrands.find(b => b.id === value);
    ...
    <>
      <Popover>
        <PopoverTrigger asChild>
          <Button
            variant="outline"
            className="min-h-[48px] w-full rounded-[48px] bg-white px-4 py-3 justify-between text-left font-normal border border-[#C8CDD2]">
      ...
      <Dialog
        ...
        <DialogContent>
          <DialogHeader>
            <DialogTitle>
              {editingBrand ? "Редагувати марку металу" : "Додати марку металу"}
            </DialogTitle>
          </DialogHeader>
          <div className="space-y-4 py-4">
            <div className="space-y-2">
              ...
              <Input
                ...
                placeholder="Введіть назву марки металу"
              />
            </div>
            <div className="space-y-2">
