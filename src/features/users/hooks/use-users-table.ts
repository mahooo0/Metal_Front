 ...
 function mapToUserItem(u: AdminUserItem): UserItem {
   ...
   const contactsParts = [u.email].concat(u.extraPhones ?? []).filter(Boolean) as string[];
 ...
 export function useUsersTable({
   ...
   const [currentPageState, setCurrentPageState] = React.useState<number>(currentPage);
   ...
   const handleDeleteRow = (_row: UserItem) => {
     // reserved for future delete logic
   };
