...
import ListView from "./list-viev";
  ...
  return (
    <div
      ...
      <CalendarDndProvider onEventUpdate={handleEventUpdate}>
        <div
          ...
          <div className="flex items-center gap-2">
            ...
            <Button
              ...
              <Columns className="w-4 h-4 text-gray-600 rotate-90" />
            </Button>
          </div>
        </div>
        ...
        <div
          className={cn(
            "flex flex-1 flex-col rounded-[16px] bg-white shadow-xl",
            view === "list" && "bg-transparent shadow-none"
          )}>
          {view === "month" && (
            <MonthView
