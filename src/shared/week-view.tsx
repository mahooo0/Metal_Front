...
import { EndHour, StartHour, WeekCellsHeight } from "@/shared/constants";
import { getUkrainianDayName } from "@/shared/lib/ukrainian-locale";
import { cn } from "@/shared/lib/utils";
import { useCurrentTimeIndicator } from "@/shared/use-current-time-indicator";
import { isMultiDayEvent } from "@/shared/utils";
        ...
        {days.map(day => (
          <div
            ...
            <span className="max-sm:hidden">
              {getUkrainianDayName(day.getDay(), true)} {format(day, "dd")}
            </span>
          </div>
        ))}
      </div>
