...
import {
  BendingAnalyticsAccordionTable,
  BendingAnalyticsTable,
} from "@/features/analitics-bending";
...
export default function AnalyticsBendingPageClient() {
