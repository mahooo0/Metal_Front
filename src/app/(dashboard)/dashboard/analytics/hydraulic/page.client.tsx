...
import {
  HydraulicAnalyticsAccordionTable,
  HydraulicAnalyticsTable,
} from "@/features/analitics-hydraulic";
...
export default function AnalyticsHydraulicPageClient() {
